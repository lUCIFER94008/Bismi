...
const Hero = () => {
  return (
    <section className="relative min-h-[105vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-transparent">
      {/* Optimized Cinematic Lighting - Use simpler blurs */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="space-y-12">
          ...
          >
            <Magnetic>
              <Link href="/products" prefetch={true} className="btn-luxury flex items-center gap-4 px-12 py-5 text-[11px] tracking-[0.3em] uppercase">
                Explore Vault <ArrowRight size={18} />
              </Link>
            </Magnetic>
            <Link href="/products?category=Toys" prefetch={true} className="btn-platinum px-12 py-5 text-[11px] tracking-[0.3em] uppercase border-luxury-platinum/50">
              The Collection
            </Link>
          </motion.div>
        </div>

        {/* Floating Showcase Cards - Fast entrance, hover lift */}
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          {[
            ...
            >
              {/* Background Image - Optimized with priority for top items */}
